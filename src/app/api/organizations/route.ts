...
function appendSetCookies(
    ...
    for (
        const cookie of headers.getSetCookie()
        ) {
 ...
 *
 * The Set-Cookie headers generated by
 * Better Auth are forwarded to the browser.
 */
export async function POST(
    ...
    try {
        ...
        try {
            ...
            /*
             * Better Auth organization was already created,
             * so remove it to avoid leaving an orphan.
             */
            try {
        ...
        try {
            ...
            const cookies =
                activeOrganizationHeaders.getSetCookie();
            ...
            /*
             * The workspace exists but could not be activated.
             * Roll back both Mizan and Better Auth data.
             */
            try {
                await db
                    .delete(
         ...
         *
         * Better Auth returns Set-Cookie headers
         * when changing the active organization.
         *
         * Forward every cookie to the browser.
         */
        appendSetCookies(
            response,
            activeOrganizationHeaders,
